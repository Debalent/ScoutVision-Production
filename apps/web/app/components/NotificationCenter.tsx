  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 w-4.5 h-4.5 bg-electric text-navy text-[10px] font-bold rounded-full flex items-center justify-center min-w-[18px] h-[18px]">
            {unreadCount}
          </span>
        )}
      </button>
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-96 card p-0 z-40 animate-scale-in max-h-[480px] overflow-hidden flex flex-col">
            {/* Header */}
