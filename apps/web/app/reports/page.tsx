              ...
              {(['scouting', 'comparison', 'pipeline', 'compliance'] as const).map((type) => {
                ...
                return (
                  ...
                  >
                    ...
                    {reportType === type && (
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-auto text-electric">
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-3 rounded-xl bg-electric/5 border border-electric/10">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-electric shrink-0 mt-0.5">
